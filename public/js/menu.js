...
document.write("<li><a id=\"coinousd_link\" href=\"coinousd.html?setLng=en\"><span data-i18n=\"coinousd_link\">Buy/Sell CoinoUSD</span></a></li>");
...
document.write("<li class=\"dropdown\">");
document.write("<a data-toggle=\"dropdown\" data-hover=\"dropdown\" class=\"dropdown-toggle\" href=\"#\"><span data-i18n=\"header_language\">Language</span> <b class=\" fa fa-angle-down\"></b></a>");
document.write("<ul class=\"dropdown-menu\">");
document.write("<li><a id=\"english_link\" href=\"#\">English</a></li>");
document.write("<li><a id=\"chinese_link\" href=\"convert.html?setLng=en\">中文</a></li>");
document.write("<li><a id=\"spanish_link\" href=\"convert.html?setLng=en\">Español</a></li>");
document.write("<li><a id=\"italian_link\" href=\"convert.html?setLng=en\">Italiano</a></li>");
document.write("<li><a id=\"german_link\" href=\"convert.html?setLng=en\">Deutsch</a></li>");
document.write("<li><a id=\"japanese_link\" href=\"convert.html?setLng=en\">日本語</a></li>");
document.write("<li><a id=\"russian_link\" href=\"convert.html?setLng=en\">Русский</a></li>");
document.write("<li><a id=\"french_link\" href=\"convert.html?setLng=en\">Français</a></li>");
document.write("<li><a id=\"hebrew_link\" href=\"convert.html?setLng=en\">עברית</a></li>");
document.write("<li><a id=\"lithuanian_link\" href=\"convert.html?setLng=en\">Lietuviškai</a></li>");
document.write("<li><a id=\"greek_link\" href=\"convert.html?setLng=en\">ελληνικά</a></li>");
document.write("<li><a id=\"danish_link\" href=\"convert.html?setLng=en\">Dansk</a></li>");
document.write("<li><a id=\"croatian_link\" href=\"convert.html?setLng=en\">Hrvatski</a></li>");
document.write("</ul>");
document.write("</li>");
